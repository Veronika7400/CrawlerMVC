...
function fetchProducts() {
    ...
    const url = `/Price/ProductListAllStoresReturnList?searchWord=${searchWord}&page=${page}&pageSize=${pageSize}`;
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            const nextUrl = `/Price/ProductListAllStoresReturnList?searchWord=${searchWord}&page=${nextPage}&pageSize=${pageSize}`;
...
function addSubscriber() {
    ...
    const url = `/Subscribers/AddSubscriber?frequency=${frequency}&searchWord=${searchWord}&notificationTypeName=Email&subscriptionTargetName=AllStores`;
